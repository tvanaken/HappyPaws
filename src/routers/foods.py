...
async def create_food(food: dict):
    ...
    food = Food(
        ...
        epa = food.get("epa") or
        food.get("eicosapentaenoic_acid_epa") or
        food.get("epa_eicosapentaenoic_acid"),
        dha = food.get("dha") or
        food.get("docosahexaenoic_acid") or
        food.get("docosahexaenoic_acid_dha") or
        food.get("dha_docosahexaenoic_acid"),
        calcium = food.get("calcium"),
        ash = food.get("ash"),
        l_carnitine = food.get("l_carnitine"),
        bacillus_coagulants = food.get("bacillus_coagulants") or
        food.get("bacillus_coagulans"),
        taurine = food.get("taurine"),
        beta_carontene = food.get("beta_carontene"),
        phosphorous = food.get("phosphorous") or
        food.get("phosphorus"),
        ...
        ascorbic_acid = food.get("ascorbic_acid") or
        food.get("ascorbic_acid_vitamin_c"),
        omega_6 = food.get("omega_6") or
        food.get("omega_6_fatty_acids"),
        omega_3 = food.get("omega_3") or
        food.get("omega_3_fatty_acids"),
        glucosamine = food.get("glucosamine") or
        food.get("glucoasmine"),
        zinc = food.get("zinc"),
        selenium = food.get("selenium"),
        microorganisms = food.get("microorganisms"),
        total_microorganisms = food.get("total_microorganisms") or
        food.get("total_lactic_acid_microorganisms"),
    )
    session.add(food)
